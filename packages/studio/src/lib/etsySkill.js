...
Good example (nursery): "Watercolor Sleepy Elephant Nursery Print, Soft Pastel Printable Baby Wall Art, Crescent Moon Nursery Decor"
  → stacks "Watercolor", "Sleepy", "Printable" around shared nouns — captures 3 search phrases in one phrase
Bad example (no stacking): "Watercolor Elephant Nursery Print, Sleepy Baby Elephant Wall Art, Soft Pastel Nursery Decor"
  → repeats "Elephant" and "Nursery" as separate phrases, wastes characters, misses impressions
Good example (planner): "Minimalist Weekly Planner Printable, Aesthetic Budget Tracker, Editable Canva Template"
`.trim();
